...
export const PrintTemplate = ({ estimateData, aiContent, userProfile }: PrintTemplateProps) => {
  ...
  const totalAmount =
    estimateData?.lineItems?.reduce((acc, item) => acc + item.totalPrice, 0) || 0;
      ...
      <div className="print-container">
        ...
        {estimateData?.companyLogo && (
          <div className="logo-section">
            <img src={estimateData.companyLogo} alt="Company Logo" />
          </div>
        )}
        ...
        <div className="content-section">
          ...
          <div>
            {processedDescription?.projectOverview || "No project overview available"}
          </div>
        </div>
        ...
        <div className="content-section">
          ...
          <div style={{ lineHeight: '1.7' }}>
            <p style={{ margin: '0 0 8px 0' }}>
              <strong>Estimated Project Duration:</strong> {processedDescription?.timeline || "1 Full work day"}
            </p>
            <p style={{ margin: '0 0 8px 0' }}>
              <strong>Start Availability:</strong> Can begin within 5 business days of approval
            </p>
            <p style={{ margin: '0 0 8px 0' }}>
        ...
        <div className="signature-section">
          <div className="signature-box">
            <p style={{ fontWeight: 'bold', margin: '0 0 32px 0' }}>Client Signature</p>
            <div className="signature-line"></div>
            <p style={{ margin: '0' }}>Date: __________</p>
          </div>
          <div className="signature-box signature-right" style={{ textAlign: 'right' }}>
            <p style={{ fontWeight: 'bold', margin: '0 0 32px 0' }}>Company Representative</p>
            <div className="signature-line"></div>
            <p style={{ margin: '0' }}>Date: __________</p>
          </div>
        </div>
